...
class TutorialActivity(bs.Activity):
    ...
    def __init__(self,settings={}):
        ...
        self._mapType = bsMap.PartyStadium
        ...
        try:
            ...
            class Powerup(object):
                ...
                def run(self,a):
                    ...
                    bs.Powerup(position=(0,4,0),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(1,4,0),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(-1,4,0),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(0,4,1),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(0,4,-1),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(1,4,1),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(1,4,-1),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(-1,4,1),powerupType='luckyBlock').autoRetain()
                    bs.Powerup(position=(-1,4,-1),powerupType='luckyBlock').autoRetain()
            ...
            self._entries = [Reset(),
                             SpawnSpaz(0,(0,2.5,0.0),makeCurrent=True),
                             DelayOld(1000),
                             ...
                             SpawnSpaz(0,(-0.09249162673950195, 2.337906360626221, -2.3),makeCurrent=True,flash=False),
                             SpawnSpaz(1,(0, 2.3, 0.0),makeCurrent=False,color=(1,1,0.4),
                             ...
                             SpawnSpaz(0,(0, 2.3, 0),makeCurrent=True,flash=False),
                             SpawnSpaz(1,(0.3, 2.2, -2.8),makeCurrent=False,color=(0.9,0.5,1.0),
                             ...
                             SpawnSpaz(0,(2.368781805038452, 2.337533950805664, -4.360159873962402),makeCurrent=True,flash=False),
                             SpawnSpaz(1,(-0.2, 2.3, -4.5),makeCurrent=False,color=(1.0,0.7,0.3),
                             ...
                             SpawnSpaz(0,(-4.0, 2.3, -2.5),makeCurrent=True,flash=False,angle=90),
                             SpawnSpaz(1,(1,0,-1.0),relativeTo=0,makeCurrent=False,color=(0.4,1.0,0.7),
                             ...
                             SpawnSpaz(0,(1.5, 2.3, -4.0),makeCurrent=True,flash=False,angle=0),
            ...
            DelayOld2(10),MoveLR(-0.70983),JumpRelease(),DelayOld2(30),MoveLR(-0.592181),MoveUD(-0.0588092),DelayOld2(10),MoveLR(-0.490219),MoveUD(-0.0744957),DelayOld2(10),MoveLR(-0.41963),DelayOld2(20),MoveLR(0),MoveUD(0),DelayOld2(20),MoveUD(0),
                             ...
                             SpawnSpaz(0,(-0.7, 2.3, -3.9),makeCurrent=True,flash=False,angle=-30),
                             SpawnSpaz(1,(4.5,0,-0.75),relativeTo=0,makeCurrent=False,color=(0.3,0.8,1.0),
