...
def bsGetLevels():
    ...
    return [bs.Level('Target Practice',displayName='Que ${GAME}',gameType=TargetPracticeGame,settings={},previewTexName='doomShroomPreview'),
            bs.Level('Target Practice B',displayName='${GAME}',gameType=TargetPracticeGame,settings={'Target Count':2,'Enable Impact Bombs':False,'Enable Triple Bombs':False},previewTexName='doomShroomPreview')]
...
class TargetPracticeGame(bs.TeamGameActivity):
    ...
    def getSettings(cls,sessionType):
        return [("Target Count",{'minValue':1,'default':3}),
    ...
    def onTeamJoin(self,team):
        team.gameData['score'] = bs.SecureInt(0) # we use this in place of a regular int to make it harder to hack scores
    ...
    def spawnPlayer(self,player):
        ...
        if self.settings['Enable Impact Bombs']: spaz.bombType = 'impact'
        if self.settings['Enable Triple Bombs']: spaz.setBombCount(3)
