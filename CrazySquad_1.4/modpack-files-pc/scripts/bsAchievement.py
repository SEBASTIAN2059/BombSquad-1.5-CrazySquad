...
# 30
gAchievements.append(
    Achievement('Derrota Monstruosa', 'Mostro',
                (2.0, 2.0, 2.2), 'Challenges:Final CSMP (Beta)', 1))
# 30
gAchievements.append(
    Achievement('Final', 'star',
                (1.0, 1.0, 1.2), 'Challenges:Final CSMP (Beta)', 30))

gAchievements.append(Achievement('Blanco o Negro','PandaColor',(1,1,1),'',15))
gAchievements.append(Achievement('Massacrer','marshmalloIcon',(1,1,1),'',5))
gAchievements.append(Achievement('Mega Bomber','buttonBomb',(1,1,1),'',5))
