...
values = {
    'accountSettingsWindow':{
        ...
        'signInWithTestAccountInfoText':'(тест-аккаунт; в дальнейшем используйте аккаунт устройства)',
    ...
    'achievements':{
        ...
        'Free Loader':{
            'descriptionFull':'Начать свободную для всех игру с 2 и более игроками',
            'descriptionFullComplete':'Начал свободную для всех игру с 2 и более игроками',
            'name':'Свободный загрузчик'
        },
        'Gold Miner':{
        ...
        'Stayin\' Alive':{
            ...
            'descriptionFullComplete':'Победил на уровне ${LEVEL} не умерев.',
    ...
    'achievementsUnavailableForOldSeasonsText':'К сожалению, специфика достижение не доступны для старых сезонов.',
    'addGameWindow':{
    ...
    'audioSettingsWindow':{
        'headRelativeVRAudioInfoText':'(Режим "Auto" включает его только когда подключены наушники)',
    ...
    'configGamepadWindow':{
        ...
        'analogStickDeadZoneDescriptionText':'(увеличьте, если персонаж продолжает двигаться после того, как стик отпущен)',
        ...
        'ignoredButton4Text':'Игнор Кнопка 4',
        ...
        'uiOnlyDescriptionText':'(предотвратить этот контроллер от присоединяясь игру)',
        'uiOnlyText':'Использование меню Ограничение',
    ...
    'coopSelectWindow':{
        ...
        'playNowText':'Играть',
        'pointsText':'Очки',
        'powerRankingFinishedSeasonUnrankedText':'Сезон завершен не в лиге',
        ...
        'prizesText':'Призы',
        'proMultInfoText':('Игроки с ${PRO} улучшением\n'
                           'Получают ${PERCENT}% умножителя здесь.'),
        'seeMoreText':'Подробнее...',
        'skipWaitText':'Не ждать',
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('Этот специальный профиль имеет \n'
                                  'имя и иконку, основанные на вашем аккаунте.\n'
                                  '\n'
                                  '${ICONS}\n'
                                  '\n'
        ...
        'getMoreIconsText':'Получение дополнительных иконок...',
        'globalProfileInfoText':('Глобальные профили игроков гарантированно имеют уникальные\n'
                                 'Имена. Они также включают дополнительные иконки'),
        'globalProfileText':'(глобальный профиль)',
        'highlightText':'акцент',
        'iconText':'Иконка',
        'localProfileInfoText':('Локальные игровые профили не имеют иконку и ихние имена\n'
                                'Не гарантированно уникальны. Улучшите до глобального профиля\n'
                                'Что бы зарезервировать уникальное имя и добавить дополнительную иконку'),
        ...
        'upgradeProfileInfoText':('Это зарезервирует ваше имя игрока\n'
                                  'И разрешит вам изменить иконку'),
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('Для активации в ${APP_NAME} зайдите в "Настройки->Дополнительно->Ввести промо-код".\n'
                                           'Найди на bombsquadgame.com версию игры для своей платформы.'),
        ...
        'friendPromoCodeWhereToEnterText':'(в "Настройках->Дополнительно->Ввести промо-код")',
    ...
    'internal':{
        ...
        'hasMenuControlText':'В данный момент меню контролирует ${NAME}.',
    ...
    'kickVoteFailedText':'Изгнание не удалось.',
    'kickVoteStartedText':'Голосование за вылет ${NAME}',
    'kickVoteText':'Изгнать',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Ввести промо-код',
    ...
    'votedAlreadyText':'Вы уже голосовали',
