...
values = {
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeWhereToEnterText':'(inz "Settdfings->Adwefwced->Eftcer Profmd Codze")',
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME} cúrrzntly hás ménu czntrol.',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Eznter Przomo Cdzs',
