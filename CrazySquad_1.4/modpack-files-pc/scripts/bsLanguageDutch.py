...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInfoText':'(deel voortgang over verschillende platforms)',
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME} heeft nu menu besturing.',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('Verwijdert ads en irritante schermpjes binnen het spel\n'
                                          'Ook inclusief:'),
        'buyText':'Koop',
