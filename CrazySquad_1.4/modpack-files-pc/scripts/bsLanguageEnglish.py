...
values = {
    ...
    'FailTexto':'Arrive at Horde 4 for a score.',
    'nWave1':'THE PROS',
    'nWave2':'FIGHTERS',
    'nWave3':'LET WINTER BEGIN',
    'nWave4':'A LITTLE MAGIC AND MADNESS',
    'nWave5':'MORE MADNESS',
    'nWave6':'MOSTROS!?',
    'nWave7':'SUICIDE',
    'nWave8':'EXTREME MADNESS!', 
    'nWave9':'PUTIN ATTACK!',
    'nWave10':'WINTER IS BACK!',
    'nWave11':'A LITTLE TNT AND ICE!',
    'nWave12':'FINAL BOSS',
    ...
    'help1':' /l - number of players',
    'help2':' /kick - kick player from this lobby',
    'help3':' /remove - remove player from game',
    'help4':' /gp - show player profiles',
    'help5':' /lm - last 100 messages from this chat',
    ...
    'help10':' /sm - slow Motion toggle',
    'help11':' /end - end game with curret results',
    'help12':' /heal - heal player',
    'help13':' /thaw - thaw player',
    'help14':' /shatter - shatter player',
    'help15':' /ref - map reflection',
    'help16':' /dv - day tint',
    'help17':' /nv - night tint',
    'help18':' /ac - flashing map',
    'help19':' /tint - change tint',
    'help20':' /o - funny sound',
    'help21':' /ps - play sound from modPack',
    'help22':' /quit - make the host leaving the game',
    'help23':' /pause - stop game',
    'help24':' /tnt - spawn tnt',
    'help25':' /bomb - spawn bomb',
    'help26':' /powerup - spawn powerup',
    'help27':' /blast - spawn explosion(without bomb)',
    'help28':' /freeze - freeze',
    'help29':' /cam - camera mode toggle',
    'help30':' /mp - change max player count',
    'help31':' /rise - rise player',
    'help32':' /kill - kill player',
    'help33':' /curse - curse player',
    'help34':' /gm - gode mode',
    'help35':' /icy - control for player2 of player1',
    'commandsDisableText':"I'm sorry, you can't use that here.",
