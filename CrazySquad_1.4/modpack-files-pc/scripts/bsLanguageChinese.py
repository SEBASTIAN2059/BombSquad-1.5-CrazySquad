...
values = {
    'accountSettingsWindow':{
        ...
        'notLoggedInText':'未登录',
        'resetProgressConfirmNoAchievementsText':('这样会重置合作模式的进程和\n'
                                                  '本地的高分记录（并不包括你的点券），\n'
                                                  '而且不能恢复，确定要这样做吗？'),
        'resetProgressConfirmText':('这样会重置合作模式的进程，\n'
                                    '成就和本地的高分记录\n'
                                    '（并不包括你的点券），而且不能\n'
                                    '恢复，确定要这样做吗？'),
    ...
    'achievements':{
        ...
        'Boxer':{
            'description':'一枚炸弹都不用就获得胜利',
            'descriptionComplete':'一枚炸弹都没有用就获胜了',
        ...
        'Gold Miner':{
            ...
            'descriptionFullComplete':'在${LEVEL}中用炸弹杀死了6个坏蛋',
            'name':'地雷专家'
        },
        'Got the Moves':{
    ...
    'allowText':'允许',
    'apiVersionErrorText':'无法加载模块${NAME};它的目标是API版本 ${VERSION_USED}; 我们需要 ${VERSION_REQUIRED}.',
    'audioSettingsWindow':{
    ...
    'configKeyboardWindow':{
        ...
        'keyboard2NoteText':('注：大多数键盘一次只能注册几个按键，\n'
                             '所以如果玩家另接一个单独的键盘，则两个键盘可\n'
                             '帮助他们更好地玩游戏。\n'
                             '请注意，即使在这种情况下，您也仍需\n'
                             '为两个玩家分配独特的按键。')
    },
    ...
    'connectMobileDevicesWindow':{
        ...
        'forAndroidText':'安卓',
        'forIOSText':'苹果iOS',
        'getItForText':('iOS 用戶可從 ${REMOTE_APP_NAME} 取得炸弹小分队遙控器\n'
                        'Android 使用者可以透過 Google Play 商店或者亞馬遜應用商店下载'),
    ...
    'editProfileWindow':{
        ...
        'highlightText':'副颜色',
        'iconText':'图标',
        'localProfileInfoText':('本地玩家档案不含图标，且玩家名称\n'
                                '不具唯一性。升级至全球档案，\n'
                                '以拥有唯一的游戏名称，并添加自定义图标。'),
    ...
    'gatherWindow':{
        ...
        'appInviteTitleText':'${APP_NAME} App 邀請碼',
        ...
        'friendPromoCodeRedeemLongText':'达到${MAX_USES}人后，可兑换${COUNT}免费点券。',
        ...
        'manualRouterForwardingText':'* 若要解决此问题，请尝试将您的路由器设置为将UDP端口${PORT}转发到你的本地地址',
        'manualText':'手动',
    ...
    'helpWindow':{
        ...
        'powerupShieldDescriptionText':('能吸收一点伤害，\n'
                                        '所以你不需要。'),
    ...
    'hostIsNavigatingMenusText':'- ${HOST}如主人一般导航菜单 -',
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME}目前有菜单控制权限。',
        'incompatibleNewerVersionHostText':('房主版本更高\n'
                                            '请升级'),
    ...
    'mustInviteFriendsText':('注意：你必须在“${GATHER}”面板中邀请好友，\n'
                             '或连接多个\n'
                             '手柄，和好友一起游戏。'),
    'nameBetrayedText':'${NAME}被${VICTIM}杀了。',
    'nameDiedText':'${NAME}挂啦！',
    ...
    'pressToOverrideCharacterText':'按${BUTTONS}重写您的角色',
    ...
    'randomPlayerNamesText':'威武雄壮炸弹君, 爆破鬼才, 孤傲的独行侠, 血色蘑菇云, 人来疯, 拆弹专家, 地雷战专家, 猫王也疯狂, 陨落星辰, 蛋蛋, 为你扔炸弹, 时尚弹客, 炸弹终结者, 装弹达人, 一脸杀气, 猩红玫瑰, 轰炸小分队, 飞弹风暴, 让炸弹飞, 闪电猫',
    'randomText':'随机',
    'rankText':'排行',
    'ratingText':'排名',
    ...
    'store':{
        ...
        'howToUseIconsText':'（在帳號設定裡建立公開遊戲檔案以使用這些）',
        ...
        'tips':{
            ('A perfectly timed running-jumping-spin-punch can kill in a single hit\n'
             'and earn you lifelong respect from your friends.'):('一记完美、及时的“跑跳旋转拳”可一次性击杀敌人，并\n'
                                                                  '助你一生享有好友的尊重。'),
            'Always remember to floss.':'永远记得要使用牙线。',
