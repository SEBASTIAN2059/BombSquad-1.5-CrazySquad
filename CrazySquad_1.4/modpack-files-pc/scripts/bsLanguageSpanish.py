...
values = {
    ...
    'FailTexto':'Llega a la Horda 4 para obtener un puntaje.',
    'nWave1':'LOS PROS',
    'nWave2':'LUCHADORES',
    'nWave3':'QUE EMPIEZE EL INVIERNO',
    'nWave4':'UN POCO DE MAGIA Y LOCURA',
    'nWave5':'MAS LOCURA',
    'nWave6':'MOSTROS!?',
    'nWave7':'SUICIDAS',
    'nWave8':'LOCURA EXTREMA!',
    'nWave9':'ATAQUE PUTIN!',
    'nWave10':'EL INVIERNO ESTA DE VUELTA',
    'nWave11':'UN POCO DE TNT Y HIELO!',
    'nWave12':'JEFE FINAL',
    ...
    'youNotLastMessage':'No tienes último mensaje.',
    'fastGame':'Fast game',
    'useHelp':'Use: /help [page (1-3)]',
    'useFly3d':'Use: /fly3d [all or number of /l]',
    'useRainbow':'Use: /rainbow [all or number of /l]',
    'useSkin':'Use: /skin [number of /l] [character (/skin names)]',
    'useInv':'Use: /inv [all or number of /l]',
    'useSleep':'Use: /sleep [all or number of /l]',
    'usePowerup':'Use: /powerup [name] [myPos or coordinates (X Y Z)]',
    'useBlast':'Use: /blast [radius] [myPos or coordinates (X Y Z)]',
    'useBomb':'Use: /bomb [name] [radius] [myPos or coordinates (X Y Z)]',
    'useTNT':'Use: /tnt [myPos or coordinates (X Y Z)]',
    'useRise':'Use: /rise [all or number of /l]',
    'useShatter':'Use: /shatter [all or number of /l and off for stop]',
    'useRef':'Use: /ref [type (1/0)] [scale]',
    'useHeal':'Use: /heal [all or number of /l]',
    'useMP':'Use: /mp [count] [players]',
    'useAC':'Use: /ac RGB or /ac r [brightness] [speed]',
    'useFly':'Use: /fly [all or number of /l]',
    'useGP':'Use: /gp [number of /l]',
    'useBot':'Use: /bot [count] [number of /l]',
    'useTint':'Use: /tint [color (R G B)] or /tint r [brightness] [speed]',
    'useGM':'Use: /gm [all or number of /l]',
    'useHug':'Use: /hug [all or number of /l]',
    'useRemove':'Use: /remove [all or number of /l]',
    'useBox':'Use: /box [all or number of /l]',
    'useCurse':'Use: /curse [all or number of /l]',
    'useKill':'Use: /kill [all or number of /l]',
    'useThaw':'Use: /thaw [all or number of /l]',
    'useFreeze':'Use: /freeze [all or number of /l]',
    'useKick':'Use: /kick [number of /l]',
    'useIcy':'Use: /icy your number of /l player number of /l',
    'forKick':'Only for /kick:',
    'forOtherCommands':'For other commands:',
    'limitPlayer':'Jugadores limitados a ',
    'extra':'Advanced',
    'commands':'Commands',
    ...
    'spawnMel':'Spawn Mel',
    'play':'Play!',
    'spawnSpaz':'Spawn Spaz (without AI)',
    'fightCreator':'Fight with creator',
    'bossBattle':'Boss Battle',
    'notnow':'Not now.',
    'spawnB9000':'Spawn B-9000 (without AI)',
    'spawnSpazAlive':'Spawn Spaz',
    'spawnKronk':'Spawn Kronk',
    'spawnBunny':'Spawn Bunny',
    'spawnNinja':'Spawn Snake Shadow',
    ...
    ##########Interfaz##########
    'forcedUI':('Forzar interfaz: Si no está satisfecho con el tamaño de\n'
                'interfaz en su dispositivo, puede selecionarla usted mismo.'),
    'uiStd':'Auto',
    'uiSmall':'Small',
    'uiMed':'Mid',
    'uiBig':'Big',
     ##########Preferencias##########
    'preferenceText':('Personalize el juego en algunos aspectos.\n'
                'Configure a su gusto :).'),
    ##########Otros##########
    'sceneFullScreen':'Fullscreen scene view',
    'createSystemScriptsButton':'Create system scripts folder',
    'deleteSystemScriptsButton':'Delete system scripts folder',
    'reloadMediaButton':'Reload Media',
    'endSessionButton':'End session',
    'quitButton':'Exit',
    'whatIsSystemScripts':'Creates system scripts\n in BombSquad +/sys/1.4.146/ folder.\nYou can edit it without root.',
    ...
    ##########Powerups##########
    'descriptionHealth':'Vida',
    'descriptionImpactBombs':'Bomba de Impacto',
    'descriptionStickyBombs':'Bomba Pegajosas',
    'descriptionIceBombs':'Bomba de Hielo',
    'descriptionTripleBombs':'Bombas Triples',
    'descriptionPunch':'Guantes de Boxeo',
    'descriptionShield':'Electro-Escudo',
    'descriptionCurse':'Maldicion',
    'descriptionLandMines':'Minas',
    'descriptionEndBomb':'Bomba Sonica',
    'descriptionPower':'Poder',
    'descriptionIceImpact':'Bomba Impacto-Helada',
    'descriptionMagicBomb':'Bomba Magica',
    'descriptionEggBomb':'Bombas Bot',
    'descriptionTntBombs':'Bomba Tnt',
    'descriptionSpeed':'Velocidad',
    'descriptionSuicide':'Suicida',
    'descriptionExtraLive':'Vida x2',
    'descriptionGod':'Invencibilidad',
    'descriptionDirigida':'Bombas Dirigidas',
    'descriptionUpSticky':'Bomba Ascendente',
    'descriptionPowerupBomb':'Powerups Falsos',
    'descriptionBombJumping':'Bomba Saltarina',
    'descriptionEspectralBomb':'Bomba Espectral',
    'descriptionElectricBomb':'Bomba Electrica',
    'descriptionBugBomb':'Bomba Bug',
    'descriptionShockBomb':'Bomba de Choque',
    'descriptionLuckyBlock':'Lucky Block',
    'descriptionPowerupsLol':'Ayuda Experta',
    ####################
    'characterText':'Personajes',
    'needsRestart':'Necesitas reiniciar el juego para que tome efecto.',
    'fastgame':'Fast play...',
    ...
    'help1':' /l - número de jugadores',
    'help2':' /kick - expulsa jugadores de este lobby',
    'help3':' /remove - retira un jugador del juego',
    'help4':' /gp - show player profiles',
    'help5':' /lm - ultimos 100 mensajes de este chat',
    'help6':' /fly - flight for the player',
    'help7':' /box - transform your player in box',
    'help8':' /hug - hug all players',
    'help9':' /sleep - make player sleeping',
    'help10':' /sm - alterna la cámara lenta',
    'help11':' /end - termina el juego con los resultados actuales',
    'help12':' /heal - heal player',
    'help13':' /thaw - thaw player',
    'help14':' /shatter - shatter player',
    'help15':' /ref - map reflection',
    'help16':' /dv - tinte de dia',
    'help17':' /nv - tinte de noche',
    'help18':' /ac - flashing map',
    'help19':' /tint - cambia el tinte',
    'help20':' /o - sonido divertido',
    'help21':' /ps - reproduce un sonido del modPack',
    'help22':' /quit - make the host leaving the game',
    'help23':' /pause - detiene el juego',
    'help24':' /tnt - hace aparecer TNTs',
    'help25':' /bomb - hace aparecer bombas',
    'help26':' /powerup - hace aparecer powerups',
    'help27':' /blast - crea explosiones (sin bombas)',
    'help28':' /freeze - congela jugadores',
    'help29':' /cam - alterna la cámara',
    'help30':' /mp - change max player count',
    'help31':' /rise - rise player',
    'help32':' /kill - mata jugadores',
    'help33':' /curse - curse player',
    'help34':' /gm - modo dios',
    'help35':' /icy - control for player2 of player1 (experimental)',
    'commandsDisableText':'Lo siento, No puedes usar eso aqui.',
   
    'bombTypes':'=========== bomb types ===========',
    'bomb1':' normal - bomb standard',
    'bomb2':' /kick - kick player from this lobby',
    'bomb3':' /remove - remove player from game',
    'bomb4':' /gp - show player profiles',
    'bomb5':' /lm - last 100 messages from this chat',
    'bomb6':' /fly - flight for the player',
    'bomb7':' /fly3d - new flight for the player',
    'bomb8':' /box - transform your player in box',
    'bomb9':' /hug - hug all players',
    'bomb10':' /sleep - make player sleeping',
    'bomb11':' /sm - slow Motion toggle',
    'bomb12':' /end - end game with curret results',
    'bomb13':' /io - disable slippery floor',
    'bomb14':' /heal - heal player',
    'bomb15':' /thaw - thaw player',
    'bomb16':' /rainbow - rainbow skin',
    'bomb17':' /shatter - shatter player',
    'bomb18':' /cm - freaky mode',
    'bomb19':' /ref - map reflection',
    'bomb20':' /fref - horizontal map reflection',
    'bomb21':' /dv - day tint',
    'bomb22':' /nv - night tint',
    'bomb23':' /ac - flashing map',
    'bomb24':' /tint - change tint',
    'bomb25':' /o - funny sound',
    'bomb26':' /ps - play sound from modPack',
    'bomb27':' /quit - make the host leaving the game',
    'bomb28':' /pause - stop game',
    'bomb29':' /tnt - spawn tnt',
    'bomb30':' /bomb - spawn bomb',
    'bomb31':' /powerup - spawn powerup',
    'bomb32':' /blast - spawn explosion(without bomb)',
    'bomb33':' /freeze - freeze',
    'bomb34':' /cam - camera mode toggle',
    'bomb35':' /mp - change max player count',
    'bomb36':' /inv - make the player invisible',
    'bomb37':' /rise - rise player',
    'bomb38':' /kill - kill player',
    'bomb39':' /curse - curse player',
    'bomb40':' /gm - gode mode',
    'bomb41':' /ban - ban player',
    'bomb42':' /bot - spawn friendly bot for player',
    'bomb43':' /icy - control for player2 of player1',
    'bomb44':' /nuke - drop nuke to the map',
    'bomb45':' /ban - ban player',
    'bomb46':' /vip - give vip premission for player',
    'bomb47':' /admin - give admin premission for player',
    
    'helpPage1':'=========== Help page 1 ===========',
    'helpPage2':'=========== Help page 2 ===========',
    'helpPage3':'=========== Help page 3 ===========',
    'helpOnlyAdmins':'This things are only for admins :)',
    'demoText':'Demo',
    'submitText':'Submit',
    'otherText':'Other...',
    ...
    'statsText':'Estadisticas',
    'resetProgressText':'Reiniciar Progreso',
    'resetProgressAskText':('¿Realmente quieres \n '
                                    'restablecer todas las estadísticas?'),
    'bombExplosions':'Bombas explotadas',
    'powerupTotal':'Powerups recogidos',
    'luckyBlock':'LuckyBlocks recogidos',
    'curseCures':'Maldiciones curadas',
    'crit':'Golpes fatales',
    'iceThawed':'Personajes congelados decongelados',
    'playerKills':'Jugadores asesinados',
    'playerDeaths':'Muertes del jugador',
    'betrayals':'Traiciones',
    'suicides':'Suicidios',
    'botKills':'Bots asesinados',
    'punchCounters':'Boton de puño oprimido',
    'pickupCounters':'Boton de alzar oprimido',
    'bombCounters':'Boton de bomba oprimido',
    'jumpCounters':'Boton de saltar oprimido',

    'CSMPWindow':{
        'titleText':'CSMP', 
        'contribCreditsText':'Creditos',
        'updateInfoText':'Novedades',
        'statsText':'Estadísticas',
        'extraText':'Mas ajustes',
        
        'fraseText':'Datos Extras',
        'fraseText1':'Proximamente.', #'Es un oso muy normal \nno posee grandes abilidades ',
        'fraseText2':'2',
        'fraseText3':'3',
        'fraseText4':'4',
        'fraseText5':'5',
    ...
    'ExtraSettingsWindow':{
        'titleText':'Extras', 
        'menuText':'Menú',
        'interfaceText':'Interfaz',
        'gameSettingsText':'Aj. Juego',
        'otherText':'Otros',
        'extraText':'En desarrollo...', 
        'extraDataText':'Dato extra', 
        'levelText':'Final CSMP'
    },        
    'InterfaceWindow':{
        'titleText':'Interfaz', 
        'menuText':'Tamaño',
        'interfaceText':'Interfaz',
        'interfaceSizeText':'Ajustar tamaño',
        'autoUI':'Auto',
        'bigUI':'Grande',
        'mediumUI':'Mediana',
        'smallUI':'Pequeña',
        'moreOptionsText':'Mas opciones', 
        'themeText':'Tema:',
        'themeDefaultText':'Por Defecto',
        'themeCSMPText':'CSMP',
        'themeGreenText':'Verde',
        'themeRedText':'Rojo',
        'themeDescriptionText':'Advertencia: Al cambiar el tema el juego se cerrará\npara establecer el tema y evitar errores.',
        'levelText':'Final CSMP'
    },
    'GameSettingsWindow':{
        'titleText':'Ajustes y\nPreferencias', 
        'menuText':'Tamaño',
        'interfaceText':'Interfaz',
        'powerupEffectText':'Efectos de Potenciadores',
        'effectNone':'Ninguno',
        'effectShield':'Escudo',
        'effectLight':'Luz',
        'effectName':'Nombre',
        ...
        'themeCSMPText':'CSMP',
        'themeGreenText':'Verde',
        'gsDescriptionText':'Proximamente.',
        'levelText':'Final CSMP'
    },
    'MenuSettingsWindow':{
        'titleText':'Ajustes del Menú', 
        'menuText':'Menú',
        'updateInfoText':'Novedades',
        'statsText':'Estadísticas',
        'extraText':'En desarrollo...',
        ...
        'cameraText':'Cámara',
        'descriptionText':'Nota: La opción de rotar o seguir no funciona en algunos eventos.',
        'sceneText':'Escena',
   	 'noneText':'Ninguno',
        'tintText':'Tinte',
        'tint':'Rojo',
	    ...
	    'eventText':'Evento', 
	    'event1':'Powerups', 
	    'event2':'Personajes de BombSquad',
	    'event3':'Test',
	    'event4':'Caja',
	    'event5':'CSMP',
	    'event6':'Lluvia de Bombas',
    	'cameraR':'Rotar',
   	 'cameraF':'Seguir',
  	  'slowMotion':'Cámara lenta'
    },
    'OtherSettingsWindow':{
        'titleText':'Otros Ajustes', 
        'menuText':'Comandos',
        'updateInfoText':'Novedades',
        'statsText':'Estadísticas',
        'extraText':'En desarrollo...',

        'cmd':'Habilitar comandos',
        'cmdInfoText':'Permite usar algunos comandos en chat.\nEscribe /help para ver la lista de comandos.\nPuede causar algunos retrasos (lag).',
        'disablePowers':'Desactivar habilidades',
        'disablePowersInfoText':'Esta opción deshabilita las habilidades de los personajes que las poseen. \nEsta opción es útil si queres tener una partida igualada sin ventajas \npara los que posean los personajes con habilidades.',
        'sceneText':'Escena',
   	 'noneText':'Ninguno',
        'tintText':'Tinte',
        'tint':'Rojo',
    ...
    'AdventureWindow':{
        'titleText':'Modo Historia', 
        'unFreezeFirstText':'Decongela el tiempo...',
        'unFreezeText':'Descongelar',
        'unFreezeFirst0Text':'Decongela el tiempo primero',
        'resetHistoryText?':'Realmente quieres reiniciar la\n Historia?', 
        'resetText':'Reiniciar Historia',
        'resetHText':'La historia se ha reiniciado...',
        'playText':'Jugar'
    },
    'osoMaton':'Oso maton',
    'osoEspectro':'Oso Espectro',
    'dev3':'ilya50',
    'adventureText':'Modo Historia',
    'applyText':'Aplicar',
    
    'accountSettingsWindow':{
        'accountNameRules':'Los nombres no pueden contener emojis u otros caracteres especiales',
    ...
    'achievements':{
        ...
        'Precision Bombing':{
            'description':'Gana sin poderes',
            'descriptionComplete':'Ganaste sin poderes',
            'descriptionFull':'Gana ${LEVEL} sin poderes',
            'descriptionFullComplete':'Ganaste ${LEVEL} sin poderes',
        ...
        'Final':{
            'description':'Derrota todos los enemigos',
            'descriptionFull':'Derrota todos los enemigos de Final CSMP',
            'descriptionFullComplete':'No dejaste nada de ellos!',
            'name':'Que mala suerte tuvieron...'
        },
        'Derrota Monstruosa':{
            #'description':'Perdiste en la horda 3',
            'descriptionFull':'Sin palabras',
            'descriptionComplete':'Perdiste en la horda 3',
            'descriptionFullComplete':'Perdiste en la horda 3 de Final CSMP',
            'name':'Enserio?'
        }, 
        'Blanco o Negro':{
            'description':'Que es eso?',
            'descriptionComplete':'Derrotaste al panda!',
            'descriptionFull':'Vence al panda en Panditas',
            'descriptionFullComplete':'Derrotaste al panda en ${LEVEL}',
            'name':'Blanco o Negro?'
        }
    },
    'achievementsRemainingText':'Logros restantes:',
    'achievementsText':'Logros',
    'achievementsUnavailableForOldSeasonsText':'Lo sentimos, los logros específicos no están disponibles para temporadas antiguas.',
    'addGameWindow':{
        'getMoreGamesText':'Consigue Más Juegos...',
    ...
    'audioSettingsWindow':{
        'headRelativeVRAudioInfoText':'("Auto" activa esto solo si tiene unos auriculares conectados)',
    ...
    'configGamepadWindow':{
        ...
        'analogStickDeadZoneDescriptionText':'(convierte esto arriba si tu personaje \'derrapa\' cuando sueltas la palanca)',
        'analogStickDeadZoneText':'Zona Muerta del Stick Analógico',
        'appliesToAllText':'(se aplica a todos los controles de este tipo)',
        ...
        'clearText':'vaciar',
        'dpadText':'DPad',
        'extraStartButtonText':'Botón Extra de Comienzo',
        ...
        'ignoreCompletelyDescriptionText':'(evitar que este controlador afecte ya sea el juego o menús)',
        ...
        'startButtonActivatesDefaultDescriptionText':'(desactiva esto si tu botón start es más bien como un botón de \'menú\')',
        ...
        'unassignedButtonsRunText':'Los Botones sin Asignar Corren',
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('Este multiplicador aumenta en los días que juegas\n'
                              'y baja en los días que no.'),
        'activityText':'Actividad',
        'campaignText':'Campaña',
        'challengesInfoText':('Gana premios por completar mini-juegos.\n'
                              '\n'
    ...
    'creditsWindow':{
        ...
        'allMyFamilyText':'Todos mis amigos y mi familia que ayudó con las pruebas',
        ...
        'songCreditText':('${TITLE} interpretada por ${PERFORMER}\n'
                          'Compuesta por ${COMPOSER}, arreglada por ${ARRANGER}, publicada por ${PUBLISHER},\n'
                          'Cortesía de ${SOURCE}'),
    ...
    'editProfileWindow':{
        ...
        'iconText':'icono',
        'localProfileInfoText':('Los perfiles locales no tienen iconos y sus nombres no\n'
                                'son garantizadamente únicos. Mejora a un perfil global\n'
                                'para reservar un nombre único y añadir un icono personalizado.'),
        ...
        'upgradeProfileInfoText':('Esto reservará tu nombre de jugador a nivel mundial\n'
                                  'y te permitirá asignar un icono personalizado en él.'),
    ...
    'editSoundtrackWindow':{
        ...
        'cantSaveAlreadyExistsText':'¡Una banda sonora con ese nombre ya existe!',
    ...
    'errorOutOfDiskSpaceText':'falta de memoria en disco',
    'errorText':'Error',
    ...
    'finalScoreText':'Resultado final',
    'finalScoresText':'Resultados finales',
    'finalTimeText':'Tiempo final',
    'finishingInstallText':'Terminando instalación; un momento...',
    'fireTVRemoteWarningText':('* Para una mejor experiencia, \n'
                               'utiliza controles o instala la\n'
                               'app \'${REMOTE_APP_NAME}\' en tus\n'
                               'dispositivos móviles.'),
    'firstToFinalText':'Primero a ${COUNT}, Final',
    'firstToSeriesText':'Primero a ${COUNT}, Serie',
    'fiveKillText':'¡¡¡¡¡QUÍNTUPLE COMBO!!!!!',
    'flawlessWaveText':'¡Horda perfecta!',
    'fourKillText':'¡¡¡¡CUÁDRUPLE COMBO!!!!',
    'freeForAllText':'Pelea libre',
    'friendScoresUnavailableText':'Resultados no disponibles.',
    ...
    'gameListWindow':{
        ...
        'shuffleGameOrderText':'Reproducir al azar',
        'titleText':'Personaliza listas de ${TYPE}'
    },
    'gameSettingsWindow':{
        'addGameText':'Añadir juego'
    },
    ...
    'gatherWindow':{
        ...
        'aboutDescriptionText':('Usa estas pestañas para crear una fiesta.\n'
                                '\n'
                                'Las fiestas te dejan jugar y competir con\n'
                                'tus amigos en dispositivos diferentes.\n'
                                '\n'
                                'Usa el botón ${PARTY} en la parte superior\n'
                                'derecha para chatear e interactuar con tu fiesta.\n'
                                '(En un control, presiona ${BUTTON} mientras estés en el menú.'),
        'aboutText':'Acerca de',
        ...
        'earnTicketsForRecommendingAmountText':('Tus amigos recibirán ${COUNT} tiquets si prueban el juego\n'
                                                '(Y recibirás ${YOU_COUNT} tiquets por cada amigo que pruebe el juego)'),
        'earnTicketsForRecommendingText':('Comparte el juego\n'
                                          'a cambio de tíquets gratis...'),
        ...
        'friendPromoCodeInstructionsText':('Para usarlo, abre ${APP_NAME} y ve a "Ajuses-> Avanzado-> Ingresar código"\n'
        ...
        'friendPromoCodeRedeemShortText':'Puede se canjeado por ${COUNT} tiquets en el juego.',
        'friendPromoCodeWhereToEnterText':'(en "Configuración-> Avanzado-> Introducir código")',
        'getFriendInviteCodeText':'Conseguir código de invitación de amigo',
        'googlePlayDescriptionText':'Invita a jugadores Google Play a tu fiesta:',
        'googlePlayInviteText':'Invitar',
        'googlePlayReInviteText':('Existen ${COUNT} jugadores Google Play en tu fiesta\n'
        ...
        'inDevelopmentWarningText':('Nota:\n'
                                    '\n'
                                    'Juego de Red es una función nueva todavía en desarrollo.\n'
                                    'Por ahora, es altamente recomendado que todos\n'
                                    'los jugadores estén en la misma red Wi-Fi'),
        'internetText':'Internet',
        'inviteAFriendText':('¿Tus amigos no tienen el juego? Invitalos a\n'
                             'probarlo y recibirán ${COUNT} tiquets gratis.'),
        'inviteFriendsText':'Invita a amigos',
        'joinPublicPartyDescriptionText':'Entrar en una fiesta pública:',
        'localNetworkDescriptionText':'Únete a una fiesta en tu red:',
        'localNetworkText':'Red Local',
        'makePartyPrivateText':'Hacer mi fiesta privada',
        'makePartyPublicText':'Hacer mi fiesta publica',
        'manualAddressText':'Dirección',
        'manualConnectText':'Conectar',
        'manualDescriptionText':'Únete a una fiesta por dirección:',
        'manualJoinableFromInternetText':'¿Se te pueden unir vía Internet?',
        'manualJoinableNoWithAsteriskText':'NO*',
        'manualJoinableYesText':'SI',
        'manualRouterForwardingText':'*para arreglar esto, trata de configurar tu router a mandar el puerto UDP ${PORT} a tu dirección local',
        'manualText':'Manual',
        ...
        'wifiDirectDescriptionTopText':('Wi-Fi Directo puede ser utilizado para conectar dispositivos Android sin\n'
                                        'tener que utilizar una red Wi-Fi. Esto funciona mejor a partir de Android 4.2.\n'
                                        '\n'
    ...
    'getTicketsWindow':{
        ...
        'inProgressText':'Una transacción se encuentra en progreso; por favor inténtalo de nuevo',
        'purchasesRestoredText':'Compras Restauradas.',
        'receivedTicketsText':'¡${COUNT} tickets recibidos!',
        'restorePurchasesText':'Restaurar Compras',
        'ticketDoublerText':'Duplicador de Tiquetes',
        'ticketPack1Text':'Paquete de Tickets Pequeño',
        'ticketPack2Text':'Paquete de Tickets Mediano',
        'ticketPack3Text':'Paquete de Tickets Grande',
        'ticketPack4Text':'Paquete de Tickets Jumbo',
        'ticketPack5Text':'Paquete de Tickets Mamut',
        'ticketPack6Text':'Paquete de Tickets Final',
        'ticketsFromASponsorText':('Obtén ${COUNT} tickets\n'
                                   'de un patrocinador'),
        'ticketsText':'${COUNT} Tickets',
        'titleText':'Conseguir Tickets',
        'unavailableLinkAccountText':('Lo sentimos, las compras no están disponibles en esta plataforma.\n'
                                      'Como una solucion, puedes enlazar esta cuenta a otra\n'
                                      'plataforma y hacer tus compras allí.'),
        'unavailableTemporarilyText':'Esto no está disponible por el momento, por favor intenta más tarde.',
        'unavailableText':'Lo sentimos, esto no se encuentra disponible.',
        'versionTooOldText':'Lo sentimos, esta versión del juego es muy vieja; por favor actualiza el juego.',
        'youHaveShortText':'Tienes ${COUNT}',
        'youHaveText':'Tienes ${COUNT} tickets'
    },
    'googlePlayText':'Google Play',
    ...
    'helpWindow':{
        'bombInfoText':('- Bomba -\n'
                        'Mas fuertes que los golpes, pero puede\n'
        ...
        'controllersInfoText':('Puedes jugar ${APP_NAME} con tus amigos en una red, o todos puende\n'
                               ...
                               'tus dipositivos moviles como conroles instalando la app \'${REMOTE_APP_NAME}\'.\n'
                               'Ve a \'Ajustes-> Controles\' para mas información.'),
        ...
        'powerupSpeedDescriptionText':('Te equipa unas zapatillas que te dan velocidad.\n'
                                             'Podras llegar rapido a cuarquier lugar o evadir algo.\n'
                                             'Pero no podras evadir su rechazo. :('),
        'powerupSpeedNameText':'Velocidad',
        'powerupLuckyBlocksDescriptionText':('Todo depende de ti.\n'
                                             'pero ten cuidado porque puedes tenes mala suerte.\n'
                                             'o tal vez no.'),
        'powerupLuckyBlocksNameText':'Lucky Block',
        'powerupEspectralBombsDescriptionText':('¿Y que es un espectro?, bueno no importa.\n'
                                             'pero ten cuidado que no te explote cerca.\n'
                                             'porque se metera en tu cuerpo y luego moriras.'),
        'powerupEspectralBombsNameText':'Bombas Espectrales',
        'powerupSuicideDescriptionText':('Te convierte en un suicida.\n'
                                             'tambien tendras bombas especiales.'),
        'powerupSuicideNameText':'El Suicida',
        'powerupMagicBombsDescriptionText':('¿A quien no le gusta la idea de ser un mago?.\n'
                                             'pues bien aqui tienes la oportunidad de cumplir tu sueño.'),
        'powerupMagicBombsNameText':'Bombas Magicas',
        'powerupTntBombsDescriptionText':('Una tnt a menor escala, mm interesante.\n'
                                             'es poderosa, ten cuidado.'),
        'powerupTntBombsNameText':'Bombas TNT',
        'powerupIceImpactBombsDescriptionText':('He aqui la bomba de hielo v2.0.\n'
                                             'con mas alcanze jeje.'),
        'powerupIceImpactBombsNameText':'Bombas Impacto-Heladas',
        'powerupEndBombsDescriptionText':('Si te explota al lado mueres.\n'
                                             'no importa que tan bien equipado estes.'),
        'powerupEndBombsNameText':'Bombas del Fin',
        'powerupExtraLiveDescriptionText':('Te cura, y ademas duplica tu salud.\n'
                                             '¡no es eso algo increible!.'),
        'powerupExtraLiveNameText':'Caja de salud 2.0',
        'powerupFakePowerupsDescriptionText':('Estas vienen en grupos de 4.\n'
                                             '¿Son powerups?, no te deje engañar por su apariencia.\n'
                                             '¡usalas para engañar a tus amigos!.'),
        'powerupFakePowerupsNameText':'Powerups Falsos',
        'powerupShockBombsDescriptionText':('Esta bomba produce choques en un radio determinado.\n'
                                             'Tambien afecta a los objetos o jugadores cercanos.'),
        'powerupShockBombsNameText':'Bombas Shock',
        'powerupPowerDescriptionText':('¿Haz jugado el SMP, bueno esto es copy-paste.\n'
                                             'asi que, creditos a Froshlee14.\n'
                                             '¡aumenta tu fuerza!.'),
        'powerupPowerNameText':'Poder',
        'ouyaIconDescriptionText':('¿Haz jugado el SMP, bueno esto es copy-paste.\n'
                                             'asi que, creditos a Froshlee14.'),
        'ouyaIconNameText':'Bombas de Largo Alcance',
        'powerupJumpBombsDescriptionText':('Esta bomba solo quiere saltar.\n'
                                             'es dificil dominarla.'),
        'powerupJumpBombsNameText':'Bombas Saltarinas',
        'powerupUpStickyBombsDescriptionText':('Pegasela a alguien y lo veras irse al cielo.\n'
                                             'tienes 2 segundos antes de que se empieze a elevar.'),
        'powerupUpStickyBombsNameText':'Up-Sticky',
        'powerupElectricBombsDescriptionText':('Electricidad jeje.\n'
                                             'si te explota cerca te paraliza.'),
        'powerupElectricBombsNameText':'Bombas Electricas',
        'powerupToolsDescriptionText':('He aqui algo que te sera de mucha ayuda.\n'
                                             'es algo muy op, no se.'),
        'powerupToolsNameText':'Ayuda Experta',
        'powerupInvincibleDescriptionText':('No te podran hacer daño.\n'
                                             'excepto las mentiras de ella. :('),
        'powerupInvincibleNameText':'Invencibilidad',
        'powerupInvisibleDescriptionText':('Eres invisible, que haras.\n'
                                             'nadie te puede ver, ^v^.'),
        'powerupInvisibleNameText':'Invisibilidad',
        'powerupBugBombsDescriptionText':('Un extraño virus que te afecta\n'
                                             'y daña tu cuerpo temporalmente.\n'
                                             'para que logres sobrevivir no intentes correr.'),
        'powerupBugBombsNameText':'Bombas Bug',
        'powerupEggBombsDescriptionText':('Esta bomba spawneara un bot.\n'
                                             'te digo que solo sera uno, ¡suerte!.'),
        'powerupEggBombsNameText':'Bombas Egg',
        'powerupAimBombsDescriptionText':('Esta bomba seguira a su objetivo\n'
                                             'y se lo llevara fuera de la plataforma.\n'
                                             '¿Podras evitar que te atrape?.'),
        'powerupAimBombsNameText':'Bombas Dirigidas',
    ...
    'settingsWindow':{
        ...
        'customMenuText':'Menu principal',
        'moreSettingsText':'Mas ajustes',
        'moreUwUText':' ',
        'titleText':'Ajustes'
    },
    'moreSettingsWindow':{
        'titleText':'Mas ajustes',
        'bombShieldText':'Mostrar radio de explosion de bomba',
        'shieldPlayerText':'Colocar escudo al igual que jugador',
        'powerupNameText':'Mostrar nombre de potenciadores',
        'bombNameText':'Mostrar nombre de bombas',
    },
    ...
    'contribCreditsWindow':{
        'titleText':'CSMP',
        'title2Text':'Ceditos de CrazySquad',
        'text0Text':'Creador del modpack:',
        'text1Text':'Lista de contribuidores:',
        'textExtra':'Eso es todo.',
        'text2Text':'Tu quieres contribuir?\n   Contactame: ',
        'text3Text':'Testers: ',
    },
    'updateInfoWindow':{
        'titleText':'Update',
        'titleInfoText':'Novedades',
        'subtitleText':'Novedades:',
        'subtitle2Text':'Descubrelo tu mismo!', #'Personajes:',
        'subtitle3Text':'Powerups:',
        'subtitle4Text':'Bombas:',
        'subtitle5Text':'Mapas:',
        'subtitle6Text':'Cambios:',
        'text1Text':'   -Health\n   -Curse\n   -Punch\n   -Impact\n   -Ice\n   -Sticky\n   -Shield\n   -Bomb\n   -LandMine\n   -Speed\n   -Fireman\n   -Frosty??\n   -Conejo Gordo\n   -Pixel 2\n   -Ninja Mariposa\n   -Kronka\n   -Huesos Rosa\nNota: Algunos personajes poseen habilidades.',
        'text2Text':'   -Powerup de Bomba Espectral\n   -Powerup de Invisibilidad\n   -Powerup de Bomba Egg\n   -Powerup de Bomba Bug\n   -Powerup de Bomba Dirigida',
        'text3Text':'   -Bomba Espectral\n   -Bomba de Fuego\n   -Bomba Egg\n   -Bomba Bug\n   -Bomba Dirigida',
        'text4Text':'   -Party Stadium',
        'text5Text':('   -Se disminuyo el radio de explosion de las bombas\n Impacto-Helada, Magica, Tnt y La bomba de Vida.\n'
                  '   -Se agregaron 9 eventos mas al powerup LuckyBlock.\n'
                  '   -Se cambio el comportamiento del Bot Pascal.\n'
                  '   -Se añadieron dos nuevos bots: Neon Bot\n y Oso maton Bot.\n'
                  '   -Se corrigio el problema con el personaje Oso Espectro,\n el cual siempre estaba de un solo color.\n Ahora se le podra cambiar el color sin problema.\n'
                  '   -Ahora la paleta de colores es de 5x5 con colores\n Flourecentes.\n'
                  '   -Ahora podras incrementar hasta 3 el color en el\n apartado de colores personalizados.')
    },
    'shareText':'Compartir',
    ...
    'store':{
  	  ...
  	  'achievementsUnlockText':'Completa algunos logros para obtener esto (En desarrollo)',
		'extraCharactersText':'Logros',
    ...
    'tutorial':{
        ...
        'phrase02Text':'¡Bienvenido a CrazySquad!',
        'phrase03Text':'Aquí van unos consejos para manejar a tu personaje:',
        'phrase04Text':'Muchas cosas en CrazySquad se basan en FÍSICAS.',
        ...
        'randomName1Text':'Diego',
        'randomName2Text':'Yesid',
        'randomName3Text':'Jhon',
        'randomName4Text':'Loco',
        'randomName5Text':'Elver Gazo',
