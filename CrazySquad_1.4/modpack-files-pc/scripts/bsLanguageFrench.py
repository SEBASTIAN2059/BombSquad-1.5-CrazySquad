...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsEnterCodeText':'Entrez votre code',
    ...
    'gatherWindow':{
        ...
        'dedicatedServerInfoText':'Pour de meilleur résultat, créer un server dédiqué. Voir bombsquadgame.com/server pour savoir comment faire.',
        'disconnectClientsText':('Ceci déconnectera le(s) ${COUNT} joueur(s)\n'
                                 'de votre partie. Soyez-vous certain?'),
        ...
        'earnTicketsForRecommendingText':('Partagez le jeu pour \n'
                                          'recevoir des tickets gratuitement...'),
        ...
        'friendPromoCodeInstructionsText':('Pour l\'utiliser, ouvrez ${APP_NAME} puis aller dans "Paramètres->Avancé->Entrer Votre Code Promo".\n'
                                           'Allez sur bombsquadgame.com pour trouver des liens de téléchargement toutes plates-formes compatibles confondues.'),
        ...
        'friendPromoCodeWhereToEnterText':'(dans "Paramètres->Avancé->Entrer Votre Code Promo")',
        ...
        'inviteAFriendText':('Vos amis n\'ont pas le jeu? Invitez-les pour qui\'ils\n'
                             'l\'essayent et ils gagneront ${COUNT} billets gratuit.'),
        ...
        'wifiDirectDescriptionBottomText':('Si tous les appareils ont un onglet \'Wi-Fi Direct\', ils devraient être capables de \n'
                                           'ce connecter entre eux. Quand tous les appareils sont connectés, vous pouvez créer des \n'
                                           'groupes en utilisant l\'onglet \'Réseau Local\', pareil qu\'un réseau Wi-Fi régulier. \n'
                                           '\n'
    ...
    'helpWindow':{
        'bombInfoText':('- Bombe -\n'
                        'Plus fortes que les poings, elles peuvent \n'
                        'causer des blessures graves à soi-même. \n'
                        'Pour éviter ça, jetez-les vers les ennemis \n'
        ...
        'orPunchingSomethingText':'Ou frappez quelque chose, jetez la d\'une falaise, et explosez la en tombant avec un bombe collante.',
        'pickUpInfoText':('- Attraper -\n'
                          'Saisissez des drapeaux, ennemis, ou tout autre \n'
                          'autre chose qui n\'est pas boulonné au plancher. \n'
                          'Appuyez encore une fois pour lancer.'),
        ...
        'powerupStickyBombsDescriptionText':('Collent à tout ce qu\'elles touchent.\n'
                                             'Fous rires garantis.'),
        'powerupStickyBombsNameText':'Bombes collantes',
        'powerupsSubtitleText':'Évidemment, aucun jeu est complet sans des bonus:',
        'powerupsSubtitleTextScale':0.8,
        'powerupsText':'Bonus',
        'powerupsTextScale':1.4,
        'punchInfoText':('- Frapper -\n'
                         'Les poings font plus de dommage \n'
                         'avec plus de rapidité, donc courez et \n'
                         'tournoyez comme un fou.'),
    ...
    'hostIsNavigatingMenusText':'- ${HOST} navigue dans les menus like a boss -',
    'importPlaylistCodeInstructionsText':'Utilisez le code suivant pour importer cette playlist ailleurs:',
    'importPlaylistSuccessText':'${TYPE} Playlist \'${NAME}\' importé',
    'importText':'Importer',
    ...
    'internal':{
        ...
        'buttonText':'bouton',
        'cantKickHostError':'Impossible de sortir l\'hote.',
        'chatBlockedText':'Le chat est bloquée pour ${NAME} pendant ${TIME} secondes.',
        ...
        'corruptFileText':'Fichier(s) corrompu(s) détecté(s). Essayez de réinstaller le jeu, ou envoyez un mail à ${EMAIL} (En Anglais SVP)',
        ...
        'incompatibleVersionHostText':('L\'hôte joue avec une version différente du jeu.\n'
                                       'Vérifiez que vous êtes tous les deux à jour et réessayez.'),
        'incompatibleVersionPlayerText':('${NAME} joue avec une version différente du jeu.\n'
                                         'Vérifiez que vous êtes tous les deux à jour et réessayez.'),
        ...
        'serverRestartingText':'Redémarrage du serveur rejoindre dans un moment',
    ...
    'pressToSelectTeamText':'appuyez sur ${BUTTONS} pour sélectionner un équipe',
    ...
    'promoSubmitErrorText':'Erreur avec la soumission de votre code promo; vérifiez votre connexion à internet',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Entrez Votre Code Promo',
    ...
    'sharingText':'Partage...',
    'showText':'Montre',
    'signInForPromoCodeText':'Vous devez vous connecter à un compte pour que les codes promo prennent effet.',
    ...
    'store':{
        ...
        'extrasText':'Extras',
        'freeBombSquadProText':('BombSquad est maintenant gratuit, mais parce que vous avez déjà acheté \n'
                                'le jeu vous avez reçu BombSquad Pro et ${COUNT} billets en remerciement.\n'
    ...
    'storeText':'Magasin',
    'submittingPromoCodeText':'Soumettre le Code Promo...',
    'teamsText':'Équipes',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            ('Received ${COUNT} tickets for signing in.\n'
             'Come back tomorrow to receive ${TOMORROW_COUNT}.'):('Vous avez reçu ${COUNT} tickets pour vous connexion.\n'
                                                                  'Revenez demain et vous recevrez ${TOMORROW_COUNT}.'),
            ...
            'You don\'t have enough tickets for this!':'Vous n\'avez pas assez de tickets pour acheter ceci!',
            'You don\'t own that.':'Cela ne vous appartient pas!',
            'You got ${COUNT} tickets!':'Vous avez reçu ${COUNT} billets!',
        ...
        'settingNames':{
            ...
            'Chosen One Time':'Temps à tenir pas l\'élu',
            'Enable Impact Bombs':'Activer les bombes d\'impact',
            'Enable Triple Bombs':'Activer les Triples-Bombes',
            'Entire Team Must Finish':'Votre team entiere doit avoir fini',
            'Epic Mode':'Mode Épique',
            'Flag Idle Return Time':'Temps de retour du drapeau si immobile',
            'Flag Touch Return Time':'Temps de retour du drapeau après touche',
        ...
        'tips':{
            ...
            ('If you are short on controllers, install the \'${REMOTE_APP_NAME}\' app\n'
             'on your mobile devices to use them as controllers.'):('Si vous manquez des contrôleurs, installez l\'app \'${REMOTE_APP_NAME}\'\n'
                                                                    'sur vos appareils mobiles pour utiliser comme contrôleurs.'),
            ...
            ('If you get a sticky-bomb stuck to you, jump around and spin in circles. You might\n'
             'shake the bomb off, or if nothing else your last moments will be entertaining.'):('Si une bombe-gluante est collée à vous, sautez et tournez. Vous pourriez vous en \n'
                                                                                                'débarrasser, si ça ne fonctionne pas vos derniers instants seront divertissant.'),
            ...
            ('The head is the most vulnerable area, so a sticky-bomb\n'
             'to the noggin usually means game-over.'):('La tête est la plus vulnérable, une \n'
                                                        'bombe gluante à la tête c\'est game-over.'),
            ('This level never ends, but a high score here\n'
             'will earn you eternal respect throughout the world.'):('Ce niveau finit jamais, mais un meilleur score \n'
                                                                     'vous mériterez du respect éternel de tout le monde.'),
            ...
            ('You take damage when you whack your head on things,\n'
             'so try to not whack your head on things.'):('Vous prenez de dommage quand vous claquez votre tête,\n'
                                                          'alors ne claquez pas votre tête.'),
    ...
    'tutorial':{
        'cpuBenchmarkText':'lancer le tutoriel à une vitesse ridicule (principalement pour tester la vitesse du CPU)',
        ...
        'randomName2Text':'Maurice',
        'randomName3Text':'Guy',
        'randomName4Text':'Jacques',
        'randomName5Text':'Jeremy',
        'skipConfirmText':'Voulez-vous vraiment passer le tutoriel? Appuyez pour confirmer.',
        'skipVoteCountText':'${COUNT}/${TOTAL} votes pour passer',
        'skippingText':'passage du tutoriel...',
        'toSkipPressAnythingText':'(appuyez sur n\'importe quelle touche pour passer le tutoriel)'
    },
