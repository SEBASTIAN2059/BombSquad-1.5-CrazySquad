...
class Bomb(bs.Actor):
    ...
    def __init__(self, position=(0,1,0), velocity=(0,0,0), bombType='normal',
        ...
        if self.bombType == 'landMine':
            ...
            textureP = (random.choice([factory.cube1Tex,factory.cube2Tex,factory.cube3Tex,factory.cube4Tex,factory.cube5Tex,factory.cube6Tex,factory.cube7Tex,factory.cube8Tex,factory.cube9Tex]))
            self.node = bs.newNode('prop', delegate=self, attrs={
                'position':position,
                'velocity':velocity,
