...
values = {
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('Para usar, abra ${APP_NAME} e vá até "Configurações-> Avançado-> Entrar Código Promocional".\n'
                                           'Veja bombsquadgame.com para os links de download de todas as plataformas disponíveis.'),
        ...
        'friendPromoCodeWhereToEnterText':'(em "Configurações-> Avançado-> Entrar Código Promocional")',
