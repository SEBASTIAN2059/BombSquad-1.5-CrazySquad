...
_gPlayerColors = [
    (1*3, 0, 0), (1, 0, 0), (0.4, 0, 0), (1, 0.5, 0),(1,1,0),
    (0, 1*3, 0), (0, 1, 0), (0, 0.4, 0), (0, 1, 0.5),(0.5,1,0),
    (0, 0, 1*3), (0, 0, 1), (0, 0, 0.4), (0, 0.5, 1),(0,1,1),
    (1*3,1*3,1*3), (1,1,1), (0.6, 0.6, 0.6), (0.3, 0.3, 0.3),(0.15,0.15,0.15),
    (0.6,0.35,0.15), (1*2, 0, 0.5*2), (1, 0, 0.5), (1,0,1),(0.5,0,1)]
gMusic = None
_gConfig = None
...
def statAdd(statName):
    """
    category: General Utility Functions
    """
    if not bs.getConfig().get('Activate',True):
        try: stat = bs.getConfig().get('Stats: ' + str(statName), 0)
        except Exception: stat = 0
        stat += 1
        bs.getConfig()['Stats: ' + str(statName)] = stat
        bs.writeConfig()
...
def _havePro():
    ...
    return True #(bsInternal._getPurchased('upgrades.pro')
