...
values = {
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('Kullanmak için ${APP_NAME} uygulamasını açın ve "Ayarlar->Gelişmiş->Promo Kodu"\n'
                                           'na gidin. Tüm platformlar arası İndirme linkleri için bombsquadgame.com a girin.'),
        ...
        'friendPromoCodeWhereToEnterText':'("Ayarlar->Promo Kodu Gir" içinde)',
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME} Şu anlık menü kontrolünde.',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Promo Kodu Gir',
