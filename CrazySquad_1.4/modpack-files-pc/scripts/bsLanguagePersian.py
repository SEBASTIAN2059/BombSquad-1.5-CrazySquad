...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsEnterCodeText':'وارد کردن کد',
        ...
        'resetProgressConfirmText':('تمام پیشرفت ها در بخش همکاری ، دستاورد ها\n'
                                    'و امتیازات بالای شما پاک خواهد شد.\n'
                                    '(به استثنای بلیط های شما)\n'
                                    'این کار نمیتواند خنثی شود. آیا مطمئنید ؟'),
        ...
        'signingInText':'در حال وصل شدن...',
        'signingOutText':'در حال قطع شدن...',
    ...
    'achievements':{
        ...
        'Boxer':{
            ...
            'descriptionComplete':'بدون استفاده از هیچ نوع بمبی برنده شدی',
        ...
        'Dual Wielding':{
            ...
            'descriptionFullComplete':'دو دسته ی بازی وصل کردی',
        ...
        'Free Loader':{
            'descriptionFull':'یک بازی به سبک هرکی برا خودش با دو بازیکن یا بیشتر شروع کن',
            'descriptionFullComplete':'.بازی تک به تک رو با بیش از دو بازیکن شروع کردی',
            'name':'بالا آور رایگان'
        },
        'Gold Miner':{
            'description':'شش حریف را با مین زمینی نابود کن',
            'descriptionComplete':'شش حریف را با مین زمینی نابود کردی',
            'descriptionFull':'شش حریف را نابود کن در مرحله ی ${LEVEL}',
        ...
        'Got the Moves':{
            ...
            'descriptionComplete':'برنده بدون استفاده از مشت و یا بمب',
        ...
        'In Control':{
            ...
            'descriptionFullComplete':'یک دسته ی بازی وصل کردی',
            'name':'بازی با دسته'
        },
        'Last Stand God':{
        ...
        'Last Stand Master':{
            'description':'به امتیاز ۲۵۰ برس',
            'descriptionComplete':'به امتیاز ۲۵۰ رسیدی',
        ...
        'Pro Football Shutout':{
            'description':'اجازه نده حریف امتیاز بگیره و برنده شو',
            'descriptionComplete':'اجازه ندادی حریف امتیاز بگیره و برنده شدی',
        ...
        'Sharing is Caring':{
            ...
            'name':'به اشتراک گذاشتن یه جور مراقبته'
        },
        'Stayin\' Alive':{
            'description':'بدون کشته شدن برنده شو',
            'descriptionComplete':'بدون کشته شدن برنده شدی',
            'descriptionFull':'بدون کشته شدن برنده شو ${LEVEL} در مرحله',
            'descriptionFullComplete':'بدون کشته شدن برنده شدی ${LEVEL} در مرحله',
            'name':'زنده ماندن'
        },
        'Super Mega Punch':{
            'description':'فقط با یک مشت، یه نفرو بُکش',
            'descriptionComplete':'فقط با یک مشت، یه نفرو کشتی',
            'descriptionFull':'فقط با یک مشت، یه نفر رو بُکش ${LEVEL} در مرحله',
    ...
    'configGamepadWindow':{
        ...
        'ifNothingHappensTryAnalogText':'اگر اتفاقی نمیفتد، سعی کنید به دکمه ی آنالوگ ارجاع دهید در عوض',
    ...
    'connectMobileDevicesWindow':{
        ...
        'bestResultsText':('برای بهترین نتایج شما به یک شبکه ی وای فای بدون لَگ نیاز دارید\n'
                           'برای رفع لگ میتوانید بقیه ی دستگاه های متصل به وای فای را خاموش کنید\n'
                           'یا نزدیک مودم بازی کنید و یا با اترنت به شبکه وصل شوید و میزبان\n'
        ...
        'forAndroidText':'Android برای',
        'forIOSText':'iOS برای',
        'getItForText':('بگیرید Apple App Store را برای اپلی ها از ${REMOTE_APP_NAME} برنامه\n'
                        'بگیریدAmazon AppstoreیاGoogle Play Store و برای اندرویدی ها از'),
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('این افزاینده ی امتیاز بیشتر میشود در روزهایی که\n'
                              'بازی میکنید و کم میشود در روزهایی که نمیکنید'),
        'activityText':'فعالیت',
        'campaignText':'عملیات',
        ...
        'forfeitNotAllowedYetText':'هنوز نمیشود این چالش را هدر داد',
    ...
    'creditsWindow':{
        ...
        'whoeverInventedCoffeeText':'هر کسی که قهوه رو ساخت'
    },
    ...
    'disableXInputDescriptionText':'به بیشتر از 4 کنترل کننده اجازه می دهد ولی ممکن است کار نکند',
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('ویرایش\n'
                    'صدا'),
        'fetchingITunesText':'...iTunesگرفتن لیست های صدا از',
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('.را باز کنید و به قسمت تنظیمات>پیشرفته>وارد کردن کد تبلیغ بروید${APP_NAME}برای استفاده از کد، برنامه\n'
                                           '.سر بزنید تا لینک دانلود بازی برای سیستم عامل های مختلف بازی را بگیرید BombSquadgame.comبه سایت'),
        ...
        'friendPromoCodeWhereToEnterText':'(در بخش تنظیمات>پیشرفته>وارد کردن کد تبلیغ)',
        ...
        'inDevelopmentWarningText':(':تذکر\n'
                                    ...
                                    'اکنون شدیداً توصیه میشود همه ی بازیکنان\n'
                                    '.در یک شبکه ی وای فای مشترک باشند'),
    ...
    'helpWindow':{
        ...
        'orPunchingSomethingText':'یا بهش مشت بزنی، از یه بلندی پرتش کنی و توی راه که داره پرت میشه با یه بمب چسبونکی بترکونیش.',
    ...
    'internal':{
        ...
        'hasMenuControlText':'درحال حاظر کنترول منو رو داره ${NAME}',
    ...
    'loadingText':'در حال بار گزاری',
    'loadingTryAgainText':'لطفا صبر کنید؛ چند لحظه دیگر دوباره امتحان کنید',
    'macControllerSubsystemBothText':'هر دو تا(توصیه نمیشود)',
    ...
    'macControllerSubsystemMFiNoteText':('.ساخته شده برای کنترلر ای او اس/مک تشخیص داده شد\n'
                                         ' شما شاید بخواهید  این ها را در .تنظیمات فعال کنید'),
    ...
    'mapSelectGetMoreMapsText':'...رفتن به بیشتر نقشه ها',
    ...
    'mostViolatedPlayerText':'پرخطا ترین بازیکن',
    'mostViolentPlayerText':'خشن ترین بازیکن',
    'moveText':'انتقال',
    'multiKillText':'! !${COUNT} کشتن.',
    ...
    'notSignedInGooglePlayErrorText':'برا استفاده از این مورد شما باید به گوگل پلی وارد شی',
    ...
    'packageModsEnabledErrorText':'شبکه بازی دردسترس نیست. بروبه تظیمات. تنظیمات پیشرفته و تیک پکیج. محلی رو ور دار',
    'partyWindow':{
    ...
    'playerDelayedJoinText':'.در راند بعد ملحق میشود ${PLAYER}',
    ...
    'playerProfilesWindow':{
        'cantDeleteAccountProfileText':'شما نمی توانید حذف کنید پروفایل مربوط به حساب کاربری را',
        'deleteButtonText':('حذف\n'
                            'پرفایل'),
        'deleteConfirmText':'؟\'${PROFILE}\' حذف',
        'editButtonText':('ویرایش\n'
                          'پرفایل'),
        'explanationText':'نام سفارشی بازیکن حاظر در این حساب کاربری',
        'newButtonText':('پروفایل\n'
                         'جدید'),
        'titleText':'پروفایلهای بازیکن'
    },
    'playerText':'بازیکن',
    ...
    'pressAnyButtonText':'فشار هر دکه ای برای ادامه',
    ...
    'pressJumpToFlyText':'**پرواز با زدن مرتب دکمه ی پرش**',
    ...
    'promoSubmitErrorText':'خطا در ارسال کد چک کنید اتصال اینترنت رو',
    ...
    'randomPlayerNamesText':'نام های پیشفرض',
    'randomText':'تصادفی',
    'rankText':'رتبه',
    'ratingText':'امتیاز',
    ...
    'remote_app':{
        ...
        'run1':'Run 1',
        'run2':'Run 2',
        'searching':'جستجو برای بازی ها فعال',
        ...
        'version_mismatch':('عدم تطابق نسخه ها\n'
                            ...
                            'بمب اسکواد آخرین ورژن باشن و دوباره امتحان کنید')
    },
    ...
    'settingsWindowAdvanced':{
        ...
        'kickIdlePlayersText':'بیرون انداختن بازیکنان غیر فعال',
        ...
        'showUserModsText':'نمایش فولدر مد ها',
        'titleText':'پیشرفته',
    ...
    'showText':'نمایش',
    'signInForPromoCodeText':'شما باید با یک حساب کاربری وارد شوید برای به اثر گذاشتن کد',
    ...
    'soundtrackTypeNames':{
        ...
        'Victory':'صفحه ی نمایش نتایج نهایی'
    },
    'spaceKeyText':'فاصله',
    ...
    'store':{
        ...
        'howToSwitchCharactersText':'(برو به "${SETTINGS} -> ${PLAYER_PROFILES}" برای ایجاد و شخصی سازی شخصیتها)',
        'howToUseIconsText':'ایجاد پروفایل های جهانی از قسمت پنجره ی حساب برای استفاده در این مورد',
        'howToUseMapsText':'(ازین نقشه ها میتونید تو بازی های تیمی و تک به تکی که خودتون هاست هستید استفاده کنید)',
        'iconsText':'آیکون ها',
    ...
    'storeDescriptions':{
        'blowUpYourFriendsText':'دوستاتو بترکون ببین چقدر کیف داره',
        'competeInMiniGamesText':'رقابت در بازی های کوچک اعم از مسابقه ی پرواز.',
        'customize2Text':'سفارشی کردن کارکتر ها، مینی بازی ها، و حتی موسیقی های متن .',
        'customizeText':'شما می تونید کاراکتر ها رو شخصی سازی کنید و به سلیقه ی خودتون لیست بازی درست کنید',
        'sportsMoreFunText':'ورزش ها سرگرم کننده تر میشن با انفجار',
        'teamUpAgainstComputerText':'تیم در مقابل کامپیوتر .'
    },
    'storeText':'فروشگاه',
    'submittingPromoCodeText':'... در حال ثبت کد',
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Infinite Onslaught':'جنگ جنگ تا پیروزی',
            ...
            'The Last Stand':'هرکی بیشتر بمونه',
            'Uber ${GAME}':'${GAME} بازی',
            'Uber Football':'فوتبال دعوایی',
            'Uber Onslaught':'هجوم',
            'Uber Runaround':'ایست بازرسی'
        },
        'gameDescriptions':{
            ('Be the chosen one for a length of time to win.\n'
             'Kill the chosen one to become it.'):('Be the chosen one for a length of time to win.\n'
        ...
        'serverResponses':{
            'A code has already been used on this account.':'کد قبلا در این حساب استفاده می شود.',
            'A reward has already been given for that address.':'.جایزه قبلا گرفته شده برای ان ادرس',
            'Account linking successful!':'ارتباط موفق با حساب کاربری',
            'Accounts are already linked.':'Accounts are already linked.',
            'An error has occurred; please contact support@froemling.net.':'An error has occurred; please contact support@froemling.net.',
            ...
            'Can\'t link 2 accounts of this type.':'نمیشه لیک دو حساب کاربری از این نوع باشن',
            'Can\'t link 2 diamond league accounts.':'Can\'t link 2 diamond league accounts.',
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'Can\'t link; would surpass maximum of ${COUNT} linked accounts.',
            'Cheating detected; scores and prizes suspended for ${COUNT} days.':'Cheating detected; scores and prizes suspended for ${COUNT} days.',
            ...
            ('Received ${COUNT} tickets for signing in.\n'
             'Come back tomorrow to receive ${TOMORROW_COUNT}.'):('Received ${COUNT} tickets for signing in.\n'
                                                                  'Come back tomorrow to receive ${TOMORROW_COUNT}.'),
            ...
            ('Would you like to link your device account to this one?\n'
             ...
             'Warning: this cannot be undone!\n'):('مایلید دستگاه تون رو به این دستگاه متصل کنید؟\n'
                                                   '\n'
                                                   'حساب دستگاهی شما ${ACCOUNT1}\n'
                                                   'این حساب ${ACCOUNT2}\n'
                                                   '\n'
                                                   'این مشکلی توی سیو و پیشرفت شما ایجاد نمیکنه.\n'
                                                   'احطار: بعدا نمیتونید پشیمون شید!'),
            ...
            'You have been promoted to a new league; congratulations!':'You have been promoted to a new league; congratulations!',
            ...
            'Your friend code was used by ${ACCOUNT}':'Your friend code was used by ${ACCOUNT}'
        },
        'settingNames':{
            '1 Minute':'۱دقیقه',
            '1 Second':'یک ثانیه',
            ...
            'Bomb Spawning':'به دنیا امدن بمب',
            ...
            'Kills to Win Per Player':'هرکی بیشتر بکشه',
            'Laps':'دور ها',
        ...
        'statements':{
            '${TEAM} is disqualified because ${PLAYER} left':'بازیرو ترک کرد ${PLAYER} ردصلاحیت شدچون ${TEAM}',
            'Killing ${NAME} for skipping part of the track!':'! مرد چون جر زنی کرد ${NAME}'
        },
        'teamNames':{
            'Bad Guys':'تیم حریف',
            'Blue':'آبی',
        ...
        'tips':{
            ...
            'Always remember to floss.':'هر که بمبش بیش ، مرگش بیشتر',
            ...
            'Don\'t spin for too long; you\'ll become dizzy and fall.':'زیاد به دور خودت نچرخ؛ تو دچار سرگیجه می شوی  و می افتی.',
            ...
            ('Hold down any button to run. You\'ll get places faster\n'
             'but won\'t turn very well, so watch out for cliffs.'):('موقع حرکت یه دکمه رو همزمان نگهدار مثلا مشت رو  تا سرعت حرکت بیشتر شه\n'
                                                                     'این موقع توی سرعت زیاد مراقب پایین افتادن از صخره باش'),
            ...
            ('If you are short on controllers, install the \'${REMOTE_APP_NAME}\' app\n'
             'on your mobile devices to use them as controllers.'):('If you are short on controllers, install the \'${REMOTE_APP_NAME}\' app\n'
            ...
            ('You can judge when a bomb is going to explode based on the\n'
             'color of sparks from its fuse:  yellow..orange..red..BOOM.'):('با دیدن رنگ جرقه ی بمب میشه فهمید چه موقع منفجر میشه\n'
                                                                            '!!!! زرد ... نارنجی ... قرمز ... بوم'),
            'You can throw bombs higher if you jump just before throwing.':'شما میتونید بمب هاتون رو دورتر پرتاب کنید اگه همزمان با یه پرش به موقع باشه',
    ...
    'tutorial':{
        ...
        'phrase19Text':'اگه بپری بمب بالاتر پرت میشه',
        ...
        'randomName2Text':'بهزاد',
        'randomName3Text':'کاوه',
        'randomName4Text':'سلمان',
        'randomName5Text':'بهرام',
        'skipConfirmText':'.واقعا از آموزش رد می شوی ؟ هر کلیدی را بزن تا رد شویم',
    ...
    'updatingAccountText':'... در حال به روز آوری حساب',
    'upgradeText':'ارتقا',
    'upgradeToPlayText':'بازی را خریداری کنید تا این گزینه فعال شود ${PRO} نسخه ی',
    'useDefaultText':'استفاده از پیش فرض',
    'usesExternalControllerText':'انجام این بازی با استفاده از کنترول خارجی برای ورود',
    ...
    'watchWindow':{
        ...
        'deleteReplayButtonText':('حذف\n'
                                  'بازبخش'),
        'myReplaysText':'بازی های ضبط شده ی من',
        ...
        'replayRenameErrorInvalidName':'نمیتوان نام بازبخش راتغیر داد: نام نامعتبر است',
